    ...
    <div class="max-w-6xl w-full animate-fade-in">
        <div class="bg-white shadow-2xl overflow-hidden flex relative rounded-3xl" style="min-height: 520px;">
            ...
            <div class="w-[58%] px-20 py-16 bg-white rounded-3xl flex flex-col justify-center">
                <h2 class="text-5xl font-bold mb-12 text-gray-800">Registration</h2>
                
                <form action="/register" method="POST" class="space-y-6">
                    @csrf
                    <div>
                        <input type="text" name="username" placeholder="Username" value="{{ old('username') }}"
                            class="w-full px-6 py-5 bg-gray-100 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all @error('username') ring-2 ring-red-500 @enderror" 
                            required />
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="password" name="password" placeholder="Password (min. 8 characters)"
                            class="w-full px-6 py-5 bg-gray-100 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all @error('password') ring-2 ring-red-500 @enderror" 
                            required />
                    </div>
                    <button type="submit" 
            ...
            <!-- Right Side - Koala Section -->
            <div class="w-[42%] chalkboard-bg rounded-tr-3xl rounded-br-3xl relative overflow-hidden">
                ...
                <div class="relative h-full flex flex-col items-center pt-8 px-8 z-10">
                    ...
                    <h3 class="text-white text-3xl font-bold mb-2 drop-shadow-lg">Welcome Back!</h3>
                    <p class="text-white text-sm mb-6 opacity-90">Already have an account?</p>
                    <a href="/login" 
                ...
                <div class="absolute top-0 left-0 w-32 h-full bg-white" style="border-top-right-radius: 100%; border-bottom-right-radius: 100%;"></div>
            </div>
