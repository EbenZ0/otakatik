        ...
        <div class="grid grid-cols-3 gap-8">
            ...
            <div class="col-span-2">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:border-indigo-300 transition">
                                <div class="flex items-start justify-between mb-2">
                                    <div class="flex-1">
                                        ...
                                        <p class="font-semibold text-gray-800">{{ Str::limit($question->question_text, 80) }}</p>
                                    </div>
                    ...
                    <a href="{{ route('instructor.quiz.add-question', $quiz->id) }}" 
            ...
            <div class="col-span-1">
                <div class="sticky top-6">
                    ...
                    <div class="bg-purple-50 rounded-lg border border-purple-200 p-4">
                        <h4 class="font-semibold text-purple-900 mb-3">⏱️ Tips Waktu</h4>
                        <ul class="text-xs text-purple-800 space-y-2">
                            <li>• Berikan waktu cukup untuk membaca & berpikir</li>
